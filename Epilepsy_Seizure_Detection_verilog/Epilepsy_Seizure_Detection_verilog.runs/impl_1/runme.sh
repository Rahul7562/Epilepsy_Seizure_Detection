...
HD_PWD='C:/Users/rahul/Desktop/Epilepsy_Seizure_Detection/Epilepsy_Seizure_Detection_verilog/Epilepsy_Seizure_Detection_verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log snn_seizure_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source snn_seizure_top.tcl -notrace
