...
REM
REM Generated by Vivado on Wed Apr 22 00:30:47 +0530 2026
...
echo "xvlog --incr --relax -prj snn_seizure_tb_vlog.prj"
call xvlog  --incr --relax -prj snn_seizure_tb_vlog.prj -log xvlog.log
